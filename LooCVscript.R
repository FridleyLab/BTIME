...
# the script named miF_data_bayesian_models.R

load("BRMS_models_foxp3_opal_540_positive_cells.RData")
start_time = Sys.time()
loo1 = loo(fit1, save_psis = FALSE, cores = 12) #, moment_match = TRUE) This option currently crashes the R session.
...
loo8 = loo(fit8, save_psis = FALSE, cores = 12) #, moment_match = TRUE)
end_time = Sys.time()
my_time = (end_time - start_time)
comp = loo_compare(loo1, loo2, loo3, loo4, loo5, loo6, loo7, loo8)
print(comp, digits = 2)
end_time = Sys.time()
my_time = (end_time - start_time)
print(my_time)
...
start_time = Sys.time()
loo1 = loo(fit1, save_psis = FALSE, cores = 12) #, moment_match = TRUE) 
loo2 = loo(fit2, save_psis = FALSE, cores = 12) #, moment_match = TRUE)
loo3 = loo(fit3, save_psis = FALSE, cores = 12) #, moment_match = TRUE)
loo4 = loo(fit4, save_psis = FALSE, cores = 12) #, moment_match = TRUE)
loo5 = loo(fit5, save_psis = FALSE, cores = 12) #, moment_match = TRUE)
